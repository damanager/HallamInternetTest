...
' . __('Need More Features and Options including Exciting 3D Slide and 100+ Advanced Features? Try ','simplicity-lite') . '<a href="' . esc_url('https://d5creation.com/theme/simplicity/') .'
...
// Front Page Heading Description
    $wp_customize->add_setting('simplicity[heading_des]', array(
        'default'        	=> __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel enim porta, porttitor dolor ut, tristique libero. Integer cursus lectus eros','simplicity-lite'),
        'capability'     	=> 'edit_theme_options',
    	'sanitize_callback' => 'esc_textarea',
        'type'           	=> 'option'
...
//  Banner Image/ Slide Image
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'slide-image' . $opsinumber, array(
        'label'    			=> __('Slide Image', 'simplicity-lite') . '-' .$opsinumber ,
...
// Featured Image Description
    $wp_customize->add_setting('simplicity[featured-description' . $fbsinumber . ']', array(
        'default'        	=> __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel enim porta, porttitor dolor ut','simplicity-lite'),
        'capability'     	=> 'edit_theme_options',
