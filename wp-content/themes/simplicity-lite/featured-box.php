...
<p><?php echo wp_kses_post(simplicity_get_option('featured-description' . $fboxn , 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel enim porta, porttitor dolor ut.')); ?></p>
</span>
...
<div class="clear"> </div>
<p><?php echo wp_kses_post(simplicity_get_option('featured-description2' . $fboxn2 , 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel enim porta, porttitor dolor ut')); ?></p>
</span>
